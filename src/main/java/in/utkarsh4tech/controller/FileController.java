package in.utkarsh4tech.controller;

import in.utkarsh4tech.service.FileSharer;
...
public class FileController {
    ...
    public FileController(int port) throws IOException {
        ...
        this.uploadDir = System.getProperty("java.io.tmpdir") + File.separator + "ShareIt-uploads";
    ...
    private record MultipartParser(byte[] data, String boundary) {
        ...
        public ParseResult parse() {
            try {
                ...
                String contentType = getString(dataAsString, filenameEnd);
        ...
        private static String getString(String dataAsString, int filenameEnd) {
        ...
        public record ParseResult(String filename, String contentType, byte[] fileContent) {
        }
    }

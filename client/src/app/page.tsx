  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-bold text-blue-600 mb-2">ShareIt</h1>
        <p className="text-xl text-gray-600">Secure File Sharing</p>
      </header>
      ...
      <footer className="mt-12 text-center text-gray-500 text-sm">
        <p>Utkarsh Sahu &copy; {new Date().getFullYear()} - Secure File Sharing</p>
      </footer>
    </div>
  );
}
